          ...
          >
            ...
            <Col span={20}>
              <Form onSubmit={this.handleOnlineSubmit}>
                ...
                <FormItem label="课程详情">
                  <Input.TextArea row={6} name="content" onChange={this.onChange} value={this.state.content}></Input.TextArea>
                </FormItem>  
                <FormItem label="课程封面">
                ...
                <FormItem label="上线价格">
                  <Input name="price" onChange={this.onChange} value={this.state.price}></Input>
                </FormItem>
                <FormItem>
          ...
          >
            ...
            <Col span={20}>
              <Form onSubmit={this.handleSubmit}>
                ...
                <FormItem label="众筹目标">
                  <Input name="target" onChange={this.onChange} value={this.state.target}></Input>
                </FormItem>          
                <FormItem label="众筹价格">
                  <Input name="fundingPrice" onChange={this.onChange} value={this.state.fundingPrice}></Input>
                </FormItem>
                <FormItem label="上线价格">
                  <Input name="price" onChange={this.onChange} value={this.state.price}></Input>
                </FormItem>
